...
public class CustomActionDispatcher : IActionDispatcher
{
    public bool TryDecodePackage(ConnectionEventArgs e, out RequestPackage package)
    {
        ...
        Console.WriteLine("CustomActionDispatcher::TryDecodePackage");
    ...
    {
        Console.WriteLine("CustomActionDispatcher::GetActionGetter");
    ...
    {
        Console.WriteLine("CustomActionDispatcher::ResponseError");
        //实现出错处理下发
